...
public class MinHeap<T, V>{
  ...
  /**
   * @param  i the position of the element to find
   * @return return the elemenent of type Element in i position
   */
  ...
  /**
   * Decrease the key of the element in i position with the newKey
   * @param  i                the index of the element
  ...
  /**
   * Increase the key of the element in i position with the newKey
   * @param  i                the index of the element
   * @param  newKey           the new key to set
   * @throws MinHeapException
   */
  ...
  /**
   * Check if the value is in the Queue, and return the index if he find it
   * @param  value the value to find in queue
   * @return       return the index if find the element, -1 if it fails
   */
